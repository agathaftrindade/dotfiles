...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; within a project.
   dotspacemacs-startup-lists '((recents-by-project . (3 . 5))
                                (projects . 10)
                                (recents . 5))
   ...
   dotspacemacs-default-font '("Fira Code:family=mono"
                               :size 10.0
                               :weight normal
                               :width normal)
