;;; doom-fae-floss-theme.el --- a candy colored theme by sailorhg -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-fae-floss-theme nil
  "Options for doom-themes."
  :group 'doom-themes)

(defcustom doom-fae-floss-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-fae-floss-theme
  :type 'boolean)

(defcustom doom-fae-floss-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-fae-floss-theme
  :type 'boolean)

(defcustom doom-fae-floss-comment-bg nil
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'doom-fae-floss-theme
  :type 'boolean)

(defcustom doom-fae-floss-padded-modeline nil
...
(def-doom-theme fae-floss
  ...
  ((bg         '("#3e3a4f" nil       nil))
   ...
   ;; (selection      dark-blue)
   ;; (builtin        blue)
   ;; (comments       (if doom-fae-floss-brighter-comments cyan orange))
   ;; (doc-comments   violet)
   ;; (constants      violet)
   ;; (functions      green)
   ;; (keywords       cyan)
   ...
   (selection      blue)
   (builtin        blue)
   ;; (comments       (if doom-fae-floss-brighter-comments cyan violet))
   (comments       cyan)
   (doc-comments   violet)
   (constants      violet)
   (functions      green)
   ...
   (-modeline-bright doom-fae-floss-brighter-modeline)
   (-modeline-pad
    (when doom-fae-floss-padded-modeline
      (if (integerp doom-fae-floss-padded-modeline) doom-fae-floss-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :background (if doom-fae-floss-comment-bg (doom-lighten bg 0.05) 'unspecified))
   ...
   ;;;; centaur-tabs
   (centaur-tabs-active-bar-face :background violet)
...
;;; doom-fae-floss-theme.el ends here
